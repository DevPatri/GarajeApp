...
//configuración para que cuando esté seleccionado industral, se anulen las que no les corresponden.
    @FXML
    ...
    private void guardarVehiculo(ActionEvent event) {
        ...
        //Inicializamos la listview donde guardamos todas las entradas.
...
//            lvVista.getItems().add(coche);
    ...
    private void borrarVehiculo(ActionEvent event) {
        ...
        if (selectedItem != null) {
            lvVista.getItems().remove(selectedItem);
